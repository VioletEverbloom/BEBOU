...
- Added back missing mods from the 26.2 port
...
- Update to 26.2
- Fix inventory profiles favourites being added to the base config
...
- Fix shaders config being overriden
...
- Change Attribute tooltip color to gold
...
- Remove unused configs in Server Pack
...
- Hide IPN Inventory Buttons

### Updates

#### Mods

- Iris Shader Folder : `1.3.0` → `1.3.1`
- ModernFix mVUS : `5.27.0-build.1` → `5.27.5-build.2`

#### Shaders

- I Like Vanilla : `1.3.3b` → `1.3.4`
- Photon Shader : `1.3` → `1.3b`
