...
Function global:SetupNeoForge {
    ...
    Write-Host "Edit JAVA_ARGS in your _variables.txt. Do not edit user_jvm_args.txt directly!"
...
Write-Host "To change the launch settings of this server, such as JVM args / flags, Minecraft version, modloader version etc., edit the _variables.txt-file."
